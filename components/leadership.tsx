...
const leadership = [
  {
    ...
    period: "2024-25",
    description:
      "Leading student governance and advocacy initiatives for graduate students at Stevens Institute of Technology.",
    icon: Users,
  },
  {
    title: "Board Member",
    organization: "MSAC (Management Student Advisory Council)",
    period: "2024",
    description: "Providing strategic input on curriculum development and student experience enhancement.",
    icon: Award,
  },
  {
