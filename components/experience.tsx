...
const experiences = [
  ...
  },
  {
    ...
    highlights: [
      ...
      "Conducted on-site surveys and supported project tracking through Gantt charts and MS Project, contributing to the on-time delivery of 10+ large-scale construction projects.",
      "Implemented basic Lean practices for material handling and coordinated with suppliers to align deliveries with project timelines, improving operational flow and reducing excess storage costs.",
      "Maintained documentation for audits and vendor evaluations, contributing to quality assurance and regulatory compliance within the supply chain process.",
    ],
    featured: false,
  },
]
